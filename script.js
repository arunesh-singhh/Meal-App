                ...
                <div id="card" class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <button id="main${element.idMeal}" class="btn btn-outline-dark active" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart" style="color: #ff0000;"></i></button>
                        </div>
                    </div>
                </div>
                `;
        ...
        html += `
          <div id="meal-details" class="mb-5">
            ...
            <div class="text-center">
              ...
              <a href="${data.meals[0].strSource}" target="_blank" class="btn btn-outline-dark mt-3">Read Article</a>
            </div>
          </div>
        `;
    });
    ...
    if (arr.length == 0) {
        ...
        for (let index = 0; index < arr.length; index++) {
            await fetchMealsFromApi(url, arr[index]).then((data) => {
                html += `
                <div id="card" class="card" style="width: 20rem; height: 400px">
